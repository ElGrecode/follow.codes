...
//
//
//    var rafId = window.requestAnimationFrame( updateAnalysers );
//    FCActions.registerVisualizerAnimationId(rafId);
//}
...
function initAudioComponents( stream ) {
    ...
    _recorder = createRecorder(_audio.sound);
    ...
    //var analyserNode = _audio.audioContext.createAnalyser();
    //analyserNode.fftSize = 2048;
    //_audio.sound.connect( analyserNode );
    //
    //var zeroGain = _audio.audioContext.createGain();
